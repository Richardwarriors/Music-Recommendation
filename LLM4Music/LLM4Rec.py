...
SYSTEM = """You are the master music recommender system. Output format: a python list. Do not explain the reason or include any other words
For example:
Example1: 
...
with open("../data/Music/prompt_ADM.txt", encoding="utf-8") as f, open("Output_result.txt","w",encoding="utf-8") as w:
    for line in f:
        t = line.strip()
